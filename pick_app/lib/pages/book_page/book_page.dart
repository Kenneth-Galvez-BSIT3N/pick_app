...
class _BookPageState extends State<BookPage> {
  ...
  FirebaseFirestore firestoreInstance = FirebaseFirestore.instance; //Firestore instantiation
  ...
  void getLatLongDestination(address) async{
    ...
    var distance = Geolocator.distanceBetween(_pickUpCoord.latitude, _pickUpCoord.longitude, _destinationCoord.latitude, _destinationCoord.longitude);
  ...
  Future<void> bookPage(pickup_location, destination,pickup_coord,destination_coord) {
    return
    firestoreInstance.collection("bookings")
    // .doc(auth.currentUser?.uid.toString())
    .add({
      'pickup_location':pickup_location,
      'destination':destination,
      'pickup_coord': {"latitude": pickup_coord.latitude, "longitude":pickup_coord.longitude},
      'destination_coord':{"latitude": destination_coord.latitude, "longitude":destination_coord.longitude},
      'status':'searching',
      ...
      Column(
        ...
        TextFormField(
          ...
          decoration: const InputDecoration(
            ...
            prefixIcon: Icon(Icons.location_pin, color: Color(0xffE1AD01),)
          ),
        ),
        ...
        TextFormField(
            ...
            decoration: const InputDecoration(
              ...
              border: OutlineInputBorder(),
              prefixIcon: Icon(Icons.flag, color: Color(0xffE1AD01),),
            ),
          ),
          const SizedBox(
            height: 10,
  ...
  const SizedBox(
        ...
        Row(
          children:  [
            ...
            Text(_price, style: const TextStyle(fontSize: 24,),),
        ]),
        const SizedBox(
          height: 10,
        ),
        SizedBox(
          ...
          child: ElevatedButton.icon(
            ...
            onPressed: ()=> bookPage(addressObject.GET_SOURCE_LOCATION(),addressObject.GET_DESTINATION_LOCATION(),_pickUpCoord,_destinationCoord,),
